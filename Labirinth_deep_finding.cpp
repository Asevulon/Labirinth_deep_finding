...
// Labirinth_deep_finding.cpp: определяет поведение классов для приложения.
//

#include "pch.h"
#include "framework.h"
#include "Labirinth_deep_finding.h"
#include "MyDlg.h"
...
BEGIN_MESSAGE_MAP(CLabirinthdeepfindingApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CLabirinthdeepfindingApp

CLabirinthdeepfindingApp::CLabirinthdeepfindingApp()
{
...
// Единственный объект CLabirinthdeepfindingApp

CLabirinthdeepfindingApp theApp;


// Инициализация CLabirinthdeepfindingApp

BOOL CLabirinthdeepfindingApp::InitInstance()
{
